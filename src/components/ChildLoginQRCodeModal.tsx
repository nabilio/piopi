      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white shadow-2xl">
        ...
        <div className="space-y-5 p-6 sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800">Connexion rapide</h2>
              <p className="text-sm text-gray-600">Scannez ce code pour ouvrir le profil de {child.full_name}.</p>
            </div>
          </div>
          ...
          {link && !loading && !error ? (
            <div className="space-y-3 rounded-2xl border border-purple-100 bg-purple-50/70 p-4 text-sm text-gray-700">
              ...
              <div className="rounded-xl bg-white p-3 text-xs text-gray-600 break-words">
                {link}
              </div>
